Namespace Exceptions
  ...
  Public Class StorageAreaNotFoundException
    Inherits ItemNotFoundException

#Region "Constructors"

    Public Sub New(ByVal itemName As String)
      MyBase.New(String.Format("Storage area '{0}' not found.", itemName), itemName)
    End Sub
    ...
    Public Sub New(ByVal itemName As String, ByVal innerException As Exception)
      MyBase.New(String.Format("Storage area '{0}' not found.", itemName), innerException)
    End Sub
